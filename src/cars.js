      ...
      <div className="mx-2 pb-[70px] pt-12">
        {
          carsList.map((item, i) => (<div key={i} className="w-full my-2 overflow-hidden bg-white rounded-lg shadow-lg ">
            <img className="object-cover" src={`${UtilsJson.baseUrl}image/${item.auto_product_images}`} alt="Car" />
            <div className="py-3 text-center border-t">
              <div className="block text-2xl font-bold text-gray-800">{item.auto_product_name}</div>
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      ...
                      <input type="text" name="auto_customer_book_name" onChange={(e) => handlechange(e)} className="mt-1 mb-1 h-8 shadow-sm px-3 rounded-sm text-slate-600 sm:text-sm border border-slate-300 hover:border-slate-500 outline-none w-full " />
